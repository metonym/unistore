...
**This fork of [unistore](https://github.com/developit/unistore) adds an intersection type for injected props in both the preact and react typings.**

**It is published under @metonym/unistore.**
